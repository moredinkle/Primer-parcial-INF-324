...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Estadistica</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding-large">Estadistica</a>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-xxxlarge">Carrera de Estadistica</h1>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      <h1>Estadistica</h1>
      <h5 class="w3-padding-32">La carrera de Estadística de la Facultad de Ciencias Puras y Naturales de la UMSA, es una unidad académica e investigativa autónoma creada el 15 de octubre de 1984. Es una de las dos únicas unidades de formación de estudiantes en estadística del país, existentes en las ciudades de La Paz y Potosí.</h5>
